...
const KuadrantOIDCPolicyCreatePage: React.FC = () => {
  ...
  const [oidcData, oidcLoaded, oidcError] = oidcResource
    ...
    : [null, false, null]; //Syntax allows for oidcResource to be null in the case of a create
  ...
  if (policyName && selectedGateway.name && clientID && issuerURL) {
    isFormValid = true;
  }
      ...
      <PageSection hasBodyWrapper={false} className="pf-m-no-padding">
        <div className="co-m-nav-title">
          ...
          <p className="help-block">
            {t(
              'OIDCPolicy configures OpenID Connect provider settings for a Gateway, enabling token-based authentication for downstream services.',
            )}
          </p>
        </div>
        <FormGroup
          ...
          <Form className="co-m-pane__form">
            ...
            <FormGroup label={t('Client ID')} isRequired fieldId="client-id">
              ...
              <FormHelperText>
                <HelperText>
                  <HelperTextItem>
                    {t('Identifier issued by the OIDC provider for this client')}
                  </HelperTextItem>
                </HelperText>
              </FormHelperText>
            </FormGroup>
            <FormGroup label={t('Issuer URL')} isRequired fieldId="issuer-url">
              ...
              <FormHelperText>
                <HelperText>
                  <HelperTextItem>
                    {t('Full URL of the OIDC provider issuer endpoint')}
                  </HelperTextItem>
                </HelperText>
              </FormHelperText>
            </FormGroup>
